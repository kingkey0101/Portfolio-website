                ...
                <div className="space-y-6">
                  <div>
                    ...
                    <p className="text-lg text-slate-300 leading-relaxed">
                      Focused on building fast, intuitive, and accessible web
                      experiences. I work with React and Next.js to turn designs
                      into clean, modern interfaces. I’m committed to writing
                      maintainable code and continuously leveling up my craft.
                    </p>
                  </div>
